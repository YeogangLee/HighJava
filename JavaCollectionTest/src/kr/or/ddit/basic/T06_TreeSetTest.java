...
public class T06_TreeSetTest {
	public static void main(String[] args) {
		...
		//거꾸로 대입한 이유: TreeSet은 자동정렬 기능이 있기 때문에
		//				  그걸 확인해보고 싶어서 거꾸로 대입
		...
		//subSet() : 범위 지정, subset(부분집합)
		//subSet(기준값1, 기준값2) => 기준값1~기준값2 사이의 값을 가져온다.
		//						   ('기준값1' 포함, '기준값2' 미포함)
		//subSet(기준값1, 논리값1, 기준값2, 논리값2)
		//=> 각 기준값을 포함할지 여부를 설정한다.(논리값이 true이면 포함 false면 포함X)
		System.out.println("K(포함)부터 N(미포함)까지 : " + ts.subSet("K", "N")); //기본값이 포함, 미포함 -> true, false
